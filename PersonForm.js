...
/*
  Komponenta PersonForm slouží k vytváření a úpravě faktur.
*/
...
const PersonForm = () => {
    ...
    const {id} = useParams();
    // Stavy pro uchování dat osoby, stavů odeslání a úspěchu
    ...
    useEffect(() => {       // načítání dat osoby, pokud jde o změnu (známe id)
        if (id) {
