/**
 * Komponenta InputSelect slouží k vytvoření seznamu pro výběr položky z možností.
 * 
 * Props:
 * - label: Popisek 
 * - multiple: Příznak, zda je povolený výběr více položek.
 * - required: Příznak, zda je vstup povinný. Defaultně false.
 * - enum: Objekt s mapováním hodnot na popisky pro případ, že položky nejsou objekty.
 * - prompt: Text prázdné hodnoty, který se zobrazí na začátku seznamu.
 * - name: Název prvku formuláře.
 * - handleChange: Funkce pro zpracování události změny hodnoty.
 * - value: Aktuální hodnota vybraná v roletovém seznamu.
 * - items: Pole objektů nebo hodnot z výčtu, ze kterého se vybírá.
 */
